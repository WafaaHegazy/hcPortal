...
public class UserResourceIntTest {
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(containsInAnyOrder(AuthoritiesConstants.USER, AuthoritiesConstants.ADMIN,AuthoritiesConstants.DOCTOR,AuthoritiesConstants.FEMALE)));
    }
    ...
    public void testUserDTOtoUser() {
        ...
        userDTO.setPatients(Collections.singleton(DEFAULT_ID));
        userDTO.setDoctors(Collections.singleton(DEFAULT_ID));
